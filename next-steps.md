...
- [app/HttpQuiz.Api.bicep](./infra/app/HttpQuiz.Api.bicep) - Azure Container Apps resources to host the 'HttpQuiz.Api' service.
- [app/http-quiz-web.bicep](./infra/app/http-quiz-web.bicep) - Azure Container Apps resources to host the 'http-quiz-web' service.
